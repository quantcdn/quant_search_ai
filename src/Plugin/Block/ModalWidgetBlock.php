...
/**
 * Provides a QuantSearch Modal Widget block (Cmd+K search).
 *
 * @Block(
 *   id = "quantsearch_modal_widget",
 *   admin_label = @Translation("QuantSearch Modal Widget"),
 *   category = @Translation("QuantSearch")
 * )
 */
class ModalWidgetBlock extends BlockBase {
  ...
  public function build() {
    ...
    return [
      '#theme' => 'quantsearch_modal_widget',
      '#site_id' => $site_id,
      '#cdn_url' => $cdn_url,
